<%@ Page Title="" Language="C#" MasterPageFile="~/AkademisyenSa.Master" AutoEventWireup="true" CodeBehind="Profil.aspx.cs" Inherits="Akili_Imza_Si.Forms.Profil" %>
                ...
                <table class="table table-borderless">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 162px">
                                <asp:Button ID="btnYukle" runat="server" class="btn btn-outline-primary" Text="Kaydet" OnClick="btnYukle_Click1" />
